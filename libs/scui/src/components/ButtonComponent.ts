...
import {ref, SingleEventEmitter, Vector2} from "@experiment-libs/utils";
import {
    CanvasFrameContext,
    InteractiveCanvas,
    InteractiveCanvasFrameContext,
    RectangleCollider, waitUntil
} from "@experiment-libs/canvas";
import type {CoroutineManager, FocusTarget} from "@alduino/coroutines";
import TextComponent from "./TextComponent";
import {clear, copyFrom, roundedRectangle} from "@experiment-libs/imui";
